...
sections:
  - type: GenericSection
    title:
      text: Beyond Breath. Beyond Mind.
      color: text-dark
      type: TitleBlock
    subtitle: ''
    text: |
  ...
  - type: FeaturedItemsSection
      ...
      - type: FeaturedItem
        ...
        image:
          ...
          styles:
            self:
              borderRadius: x-large
      - title: 12x Deeper Connection
        subtitle: The Ananta Technique
        text: >+
          Our unique blend of ancient yogic science and modern mindfulness
          deepens your meditative state 12x faster — balancing body, mind, and
          soul at once.
    ...
    actions:
      - label: Join Inner Circle
        ...
        type: Button
    badge:
      label: "beyond breath.\_ beyond mind."
      color: text-primary
      styles:
        self:
          textAlign: center
